...
According to recent benchmarks, new methods show best performance in detect disc variant (Barbitoff,et al., 2022). Including [deepvariant](https://github.com/google/deepvariant/blob/r1.6.1/docs/deepvariant-rnaseq-case-study.md) software, but complicate to install in a server without root access
...
This is a truth sets of variants for hg38 reference needed for short variant discovery in WGS. It can be found in [resource boundle](https://gatk.broadinstitute.org/hc/en-us/articles/360035890811-Resource-bundle) section
...
In contrast to other alignment methods, this method recommend using STAR aligner because it increased sensitivity compared to TopHat (especially for INDELS). They use STAR’s two-pass mode to get better alignments around novel splice junctions.
